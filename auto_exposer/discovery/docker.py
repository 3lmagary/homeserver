...
KNOWN_SERVICES = {
    ...
    "cosync-frontend": {"name": "CoSync Workspace", "port": 5173, "group": "Sync & Backup", "icon": "obsidian"},
    "cosync-backend": {"name": "CoSync API", "port": 4000, "group": "Sync & Backup", "icon": "obsidian"},
