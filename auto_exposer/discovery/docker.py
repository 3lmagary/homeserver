...
KNOWN_SERVICES = {
    ...
    "kopia": {"name": "Kopia", "port": 51515, "group": "Sync & Backup", "icon": "kopia"},
    "couchdb": {
    ...
    "radarr": {"name": "Radarr", "port": 7878, "group": "Media", "icon": "radarr"},
    "sonarr": {"name": "Sonarr", "port": 8989, "group": "Media", "icon": "sonarr"},
    "prowlarr": {"name": "Prowlarr", "port": 9696, "group": "Media", "icon": "prowlarr"},
    "bazarr": {"name": "Bazarr", "port": 6767, "group": "Media", "icon": "bazarr"},
    "qbittorrent": {"name": "qBittorrent", "port": 8080, "group": "Media", "icon": "qbittorrent"},
    "jellyseerr": {"name": "Jellyseerr", "port": 5055, "group": "Media", "icon": "jellyseerr"},
    "metube": {"name": "MeTube", "port": 8081, "group": "Media", "icon": "metube"},
