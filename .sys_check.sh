...
API_KEY="default-api-key" # MAKE SURE TO UPDATE THIS IN GITHUB
...
# 3. Concurrency Lock (Prevent duplicate running)
...
# 6. Safe CPU Extraction (Fallback to /proc/cpuinfo)
...
# 10. Safe JSON Building (Prevent Injection)
