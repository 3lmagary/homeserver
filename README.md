...
| 🌐 **Tailscale Gateway** | `setup_tailscale.sh` | Standalone LXC: Subnet Router & Exit Node for secure remote access |
...
*   **🌐 Tailscale Gateway:** A dedicated LXC acts as a Subnet Router and/or Exit Node, letting you reach your entire home lab securely from anywhere without opening ports.
